...
from instagram_emoji_bucketizer.entry import main as instagram_emoji_bucketizer_main
...
def test_entry_basic():
    ...
    with patch("instagram_emoji_bucketizer.entry.entry", side_effect=SystemExit(1)):
        assert instagram_emoji_bucketizer_main(args) != 0
